...
ASR_RESCUE_MAX_SEGMENT_SECONDS = float(os.getenv("ASR_RESCUE_MAX_SEGMENT_SECONDS", "14"))
ASR_RESCUE_LONG_SEGMENT_SECONDS = float(os.getenv("ASR_RESCUE_LONG_SEGMENT_SECONDS", "18"))
ASR_RESCUE_MIN_TEXT_CHARS_PER_SECOND = float(os.getenv("ASR_RESCUE_MIN_TEXT_CHARS_PER_SECOND", "1.2"))
